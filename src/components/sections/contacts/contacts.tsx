      ...
      <div className="grid grid-cols-1 gap-y-8 mb-8 sm:grid-cols-2 sm:gap-x-16">
        ...
        <div className="">
          ...
          <div className="flex justify-between sm:w-[380px] mx-auto px-2">
            ...
            <a href="https://github.com/kmfiguerrez" target="_blank">            
            <svg xmlns="http://www.w3.org/2000/svg" height={45} width={45} viewBox="0 0 496 512"  className="transition-colors fill-white hover:fill-blue-600">
            ...
            <a href="https://discord.com/channels/@me" target="_blank">                          
              <svg xmlns="http://www.w3.org/2000/svg" height={50} width={50} viewBox="0 0 640 512" className=" transition-colors fill-white hover:fill-blue-600">
